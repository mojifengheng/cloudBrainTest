...
输入姓名
    wait until screen contain    main_page_search_text_name.png    10
    doubleClick    main_page_search_text_name.png
    Input Text    main_page_search_text_name.png    bufaluo
    wait until screen contain    main_page_search_bufaluo.png    10
    Click    main_page_search_bufaluo

选择姓名
    wait until screen contain    main_page.png    10
    Click    main_page_search_box.png
    wait until screen contain    main_page_search_name.png    3
    Click    main_page_search_name.png
